...
test.describe('ParaBank Online Banking - Fund Transfer', () => {
  ...
  test('Verify user can login, transfer funds and see transaction', { tag: ['@Regression', '@smoke'] }, async ({ Given, When, Then }) => { 
    ...
    await When('User transfers 100 from account 13344 to account 13344'); 
